...
def update_dead_urls(filename, cache_things, local_file_path):
    ...
    for u in urls:
        ...
        try:
            ...
            if response.status_code == 404:
                print("404 error found for URL:", u)
                r = url_in_cache_re(u)
                ...
                if len(matching_cache_things) >= 1:
                    print("Replaced with local file:", matching_cache_things[0].full_path)
            ...
            print("Error checking URL:", u, e)

    print(
        "Found", len(url_replacements), "URL's that were replaced with links to local files."
    )
